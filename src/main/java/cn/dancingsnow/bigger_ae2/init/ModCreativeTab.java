...
//                        if (isAppliedFluxLoaded) output.accept(AppliedFluxItems.ADVANCED_FLUX_CELL_HOUSING);
...
//                        if (isAppliedFluxLoaded) output.accept(AppliedFluxItems.QUANTUM_FLUX_CELL);
...
//                        if (isAppliedFluxLoaded) output.accept(AppliedFluxItems.SINGULARITY_FLUX_CELL);
